    ...
    <div className="fixed inset-0 pointer-events-none z-[1] overflow-hidden" aria-hidden="true">
      ...
      <div className="portrait-left">
        ...
        >
          <g transform="translate(200, 120)">
            {/* Shadow/base */}
            <ellipse cx="0" cy="720" rx="80" ry="12" fill="#3a2020" opacity="0.5" />

            {/* Legs */}
            <path d="M-15 560 L-20 710 L-5 710 L-5 560 Z" fill="#3a2020" />
            <path d="M5 560 L5 710 L20 710 L15 560 Z" fill="#3a2020" />

            {/* Shoes */}
            <path d="M-22 710 Q-25 725 -15 725 L-3 725 Q-5 715 -5 710 Z" fill="#2a1515" />
            <path d="M7 710 Q5 715 3 725 L15 725 Q25 725 22 710 Z" fill="#2a1515" />
            ...
            <path d="M-30 330 Q-55 400 -45 460 Q-40 480 -30 470 L-30 460 Z" fill="#3a2020" />
            {/* Right arm */}
            <path d="M30 330 Q50 400 42 450 Q38 465 30 460 L30 460 Z" fill="#3a2020" />

            {/* Book in left hand */}
            <rect x="-55" y="460" width="25" height="18" rx="1" fill="#4a2a2a" transform="rotate(-10, -42, 469)" />

            {/* Collar / shirt */}
            <path d="M-12 300 L0 320 L12 300 L8 280 L-8 280 Z" fill="#4a2a2a" />

            {/* Tie */}
            <path d="M-3 320 L-2 380 L2 380 L3 320 Z" fill="#2a1515" />

            {/* Neck */}
            <rect x="-8" y="260" width="16" height="20" rx="4" fill="#3a2020" />

            {/* Head */}
            <ellipse cx="0" cy="232" rx="28" ry="35" fill="#3a2020" />
            ...
            />
            {/* Hair bangs */}
            <path d="M-22 192 Q-15 177 0 180 Q15 177 22 192 Q15 197 0 194 Q-15 197 -22 192 Z" fill="#2a1515" />

            {/* Eyes */}
            <ellipse cx="-10" cy="232" rx="3.5" ry="2" fill="#5a3a3a" />
            <ellipse cx="10" cy="232" rx="3.5" ry="2" fill="#5a3a3a" />
      ...
      <div className="portrait-right">
        ...
        >
          <g transform="translate(200, 120)">
            {/* Shadow/base */}
            <ellipse cx="0" cy="720" rx="75" ry="10" fill="#3a2020" opacity="0.5" />

            {/* Legs */}
            <path d="M-12 540 L-15 710 L-2 710 L-2 540 Z" fill="#3a2020" />
            <path d="M2 540 L2 710 L15 710 L12 540 Z" fill="#3a2020" />

            {/* Shoes - slight heel */}
            <path d="M-17 710 Q-20 723 -12 723 L0 723 Q-3 713 -2 710 Z" fill="#2a1515" />
            <path d="M2 710 Q3 713 0 723 L12 723 Q20 723 17 710 Z" fill="#2a1515" />

            {/* Skirt */}
            <path d="M-28 500 Q-32 525 -30 550 L30 550 Q32 525 28 500 Z" fill="#3a2020" />
            ...
            {/* Arms */}
            <path d="M-25 330 Q-45 400 -38 460 Q-34 475 -25 470 L-25 460 Z" fill="#3a2020" />
            <path d="M25 330 Q45 390 40 440 Q37 455 25 450 L25 440 Z" fill="#3a2020" />

            {/* Collar */}
            <path d="M-10 300 L0 318 L10 300 L6 285 L-6 285 Z" fill="#4a2a2a" />
            {/* Ribbon/bow tie */}
            <path d="M-8 310 Q0 316 8 310 Q0 322 -8 310 Z" fill="#2a1515" />

            {/* Neck */}
            <rect x="-6" y="265" width="12" height="20" rx="3" fill="#3a2020" />

            {/* Head */}
            <ellipse cx="0" cy="238" rx="24" ry="30" fill="#3a2020" />
            ...
            <ellipse cx="-8" cy="235" rx="3.5" ry="2.5" fill="#5a3a3a" />
            <ellipse cx="8" cy="235" rx="3.5" ry="2.5" fill="#5a3a3a" />
            {/* Eyelashes */}
